...
const Home = () => {
  ...
  // useEffect(() => {
  //   DataWrite.update("settings","dHUZgzsyOXlJYhoWZqqu", { tag: "General", title: "Language" });
  // }, []);

  // useEffect(() => {
  //   const settings = dataListener(
  //     "settings",
  //     null,
  //     "allSettings",
  //     [],
  ...
  //   dataListener(
  //     "settings",
  //     "j7y6rjma9poa87nGQIfC",
  //     "securitySetting",
  //     [],
  //     (data) => {
  //       console.log("Setting Found:", data);
  //     }
  //   );
  // }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Premium Car Wash &<br />
              <span className="text-blue-300">Auto Services</span> in Dar es
              Salaam
            </h1>
